        ...
        features: ["Certificate", "CPD Credits",],
                  ...
                  >
                    ...
                    <div className="flex flex-col items-start mt-6">
                      ...
                      <Link to={plan.paymentLink} target="_blank">
